 ...
 * @author Sukant Pal
 */
public class HTMLParagraphElement extends HTMLElement implements org.w3c.dom.html.HTMLParagraphElement{
    
    public static final String DEFAULT_ALIGN = "left";
    
    protected HTMLParagraphElement(HTMLDocument ownerDocument){
